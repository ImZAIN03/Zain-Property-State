...
export default function About() {
  return (
    <div className='py-20 px-10 max-w-6xl mx-auto bg-slate-200 rounded-lg mt-7'>
      ...
      <p className='font-semibold mb-4 text-slate-700'>This website was developed by: Muhammed Zain, for us.</p>
    </div>
  )
}